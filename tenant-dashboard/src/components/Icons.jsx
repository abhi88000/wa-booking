const icons = {
  dashboard: (
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zm10-3a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z" />
  ),
  calendar: (
  ...
  target: (
    <>
      ...
      <circle cx="12" cy="12" r="5" strokeWidth={1.75} fill="none" />
      <circle cx="12" cy="12" r="1" strokeWidth={1.75} fill="currentColor" />
    </>
  ),
  star: (
  ...
  gitBranch: (
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M6 3v12m0 0a3 3 0 103 3 3 3 0 00-3-3zm12-6a3 3 0 10-3-3v3m0 0a3 3 0 003 3H9" />
  ),
  save: (
