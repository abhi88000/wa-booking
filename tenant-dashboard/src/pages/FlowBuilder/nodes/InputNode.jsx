...
export default function InputNode({ data, selected }) {
  return (
    ...
    >
      ...
      <div className="text-[11px] inline-flex items-center gap-1 bg-purple-50 text-purple-700 border border-purple-200 rounded px-1.5 py-0.5">
        <Ico.tag className="w-3 h-3" />
        <span className="font-medium">{data.variable || 'unnamed'}</span>
